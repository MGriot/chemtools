...
def confidence_band(number_data: int, X: np.ndarray, x_mean: np.ndarray, y_pred: np.ndarray, SSxx: np.ndarray, t_two: float, fit_intercept: bool) -> Tuple[np.ndarray, np.ndarray]:
    """
    ...
    Example:
        ...
        CI_Y_upper, CI_Y_lower = confidence_band(number_data, x, x_mean, y_pred, SSxx, t_two, True)
